...
//	if (!group)
//		throw PBXHelperException(_TEXT("create PBObjectCreator failed: can't find group"));

	d_class = d_session->FindClass(group, nvoName);
//	if (!d_class)
//		throw PBXHelperException(_TEXT("create PBObjectCreator failed: can't find class"));
}
