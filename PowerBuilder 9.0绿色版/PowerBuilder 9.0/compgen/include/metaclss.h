...
// The Powerscript enumerated Type VariableKind  maps to the C++ enum:
...
// The Powerscript enumerated Type VariableAccess maps to the C++ enum:
// Indicates the access to the variable (public, private, protected).  
...
// The Powerscript enumerated Type VarArgKind maps to the C++ enum: 
// Indicates the kind of argument variable (by value, by reference, readonly).
// Only valid for VariableArgument!
...
// The Powerscript enumerated Type VariableCardinalityType maps to the C++ enum: 
...
// The Powerscript enumerated Type ScriptKind maps to the C++ enum: 
...
// The Powerscript enumerated Type TypeCategory maps to the C++ enum: 
...
class PBIEnumerationDef  : public PBITypeDef
{
  public: 
    ...
    virtual PBRESULT    GetNumEnumerations(PBLONG * pNumEnumerations) = 0;
};
...
public: 
	...
	virtual PBRESULT        GetNumNestedClasses(PBLONG * pNumClasses) = 0;
	virtual PBRESULT        GetNumVariables(PBLONG * pNumVariables) = 0;
	virtual PBRESULT        GetNumScripts(PBLONG * pNumScripts) = 0;
	...
	virtual PBRESULT        GetNumProperties(PBLONG * pNumProperties) = 0;
};
...
class PBIVariableDef : public PBIUnknown
{
  public:
	...
	virtual PBRESULT        GetNumArrayBounds(PBLONG * pNumBounds) = 0;
	...
	virtual PBRESULT        GetPropertyValue(PBLONG n, PBIString ** ppValue) = 0;
	virtual PBRESULT        FindPropertyValue(PBLONG * pN, PBIString * pName, PBIString ** ppValue) = 0;
	virtual PBRESULT        GetNumProperties(PBLONG * pProperties) = 0;
};
...
class PBIScriptDef : public PBIUnknown
{
  public:
	...
	virtual PBRESULT    GetName(PBIString ** ppName) = 0;
	virtual PBRESULT	GetSignature(PBIString ** ppSig) = 0;
...
class PBIVariableCardinalityDef : public PBIUnknown
{
  public: 
    ...
    virtual PBRESULT    GetNumArrayDimensions(PBLONG * pNumDimensions) = 0;
